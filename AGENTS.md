...
### 1.1 Claire 的个人喜好（设计灵感库）

做新模块、挑配色、起文案、想交互时，**优先从这些里取灵感**，而不是从通用 AI 设计模板里抓。

#### 游戏

| 喜好 | 可借鉴的元素 |
|---|---|
| **纪念碑谷** Monument Valley | 错位几何 / 不可能空间 / 低饱和柔和色调 / 极简建筑感 / 等距视角 |
| **原神** Genshin Impact | 开放世界探索感 / 元素主题分区（每个房间=一种元素）/ 角色立绘式呈现 / 奇幻氛围 |
| **光遇** Sky: Children of the Light | 治愈系氛围 / 云端飞行的轻盈感 / 柔光 + 长阴影 / 陌生人之间无言的温暖连接 |
| **像素游戏** Pixel games | 像素艺术 / 8-bit / 16-bit 复古 UI / 网格感 / 颗粒化的趣味装饰 |

#### 影视剧

| 喜好 | 可借鉴的元素 |
|---|---|
| **老友记** Friends | Central Perk 咖啡馆温馨感 / 90s 美式怀旧 / 橙紫沙发色 / "朋友相聚"的情感基调 |
| **生活大爆炸** The Big Bang Theory | 极客文化 / 科学 nerd 梗 / 室友群像 / 知识分子幽默 |
| **爱情公寓** | 中式合租公寓 / 年轻人群像 / 轻喜剧节奏 / 本土化情景喜剧氛围 |
| **武林外传** | 江湖客栈 / 中式古风幽默 / 市井烟火气 / 群像式情景喜剧 |

注意：**借灵感不是借素材**。不要直接用游戏截图 / 剧照 / 角色形象，那是版权问题。
取的是**气质和构图语言**——比如「会客厅」可以借老友记 / 武林外传 / 爱情公寓那种
"一群人聚在一个固定空间里日常相处"的群像感；「工作台 L1-L6」可以按原神元素分区思路
给每层不同的 halo theme；hero emoji 浮在光晕里那种漂浮感跟纪念碑谷的不可能空间、
光遇的云端飞行是同一种克制美学；像素游戏的网格 / 颗粒装饰可以做彩蛋（参考
[`easter-eggs.tsx`](./components/easter-eggs.tsx)）。
