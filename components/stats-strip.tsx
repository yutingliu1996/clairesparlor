...
const STATS_EN = [
  { num: '5', unit: 'yr', label: 'as a PM' },
  { num: '5', unit: 'lines', label: 'platforms in parallel' },
  { num: '41', unit: 'books', label: 'reading / read' },
  { num: '∞', unit: '', label: 'things to make' },
];

export default function StatsStrip() {
  const { lang } = useLang();
  const stats = lang === 'zh' ? STATS_ZH : STATS_EN;
  return (
